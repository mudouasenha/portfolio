                ...
                <div className="grid gap-7 lg:grid-cols-[minmax(0,1.08fr)_minmax(280px,0.82fr)] lg:items-start lg:gap-10">
                    <div className="max-w-3xl">
                        ...
                        <motion.p
                            ...
                            initial="hidden"
                            animate="visible"
                            className="mt-5 max-w-2xl text-balance text-base leading-relaxed text-foreground/80 sm:text-lg"
                        >
                            {heroLead}
                        </motion.p>
                        <motion.div
                        ...
                        >
                            {highlights.map((item) => (
                                <div key={item} className="rounded-[1rem] border border-border bg-card px-3 py-3 shadow-sm">
                        ...
                        >
                            {proofStrip.map((item) => (
                                <span
                                    key={item}
                                    className="rounded-full border border-border bg-card px-3 py-1 text-[11px] font-medium text-foreground"
                                >
                                    {item}
                                </span>
                            ))}
