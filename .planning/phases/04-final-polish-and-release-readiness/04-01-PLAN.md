...
<task type="auto">
  ...
  <verify>
    <automated>rtk rg -n "href=\"#contact\"|Let's talk|SheetContent" src/components/Navbar.tsx && rtk rg -n "id=\"about\"|id=\"technologies\"|id=\"skills\"|id=\"certifications\"|id=\"experience\"|id=\"projects\"|id=\"contact\"" src/App.tsx && rtk npm run test:integration && rtk npm run test:a11y</automated>
  </verify>
...
<verification>
Run Phase 4 code-quality gate commands after all tasks:
- `rtk npm run lint`
- `rtk npm run build`
